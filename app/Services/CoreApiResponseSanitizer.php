...
class CoreApiResponseSanitizer
{
    ...
    public function lecturer(Lecturer $lecturer): array
    {
        return [
            ...
            'display_name_with_title' => $lecturer->display_name_with_title,
            'formal_name' => $lecturer->formal_name,
    ...
    public function employee(Employee $employee): array
    {
        return [
            ...
            'display_name_with_title' => $employee->display_name_with_title,
        ...
        return [
            ...
            'head_lecturer' => $studyProgram->relationLoaded('headLecturer') && $studyProgram->headLecturer
                ? [
                    ...
                    'front_title' => $studyProgram->headLecturer->front_title,
                    'back_title' => $studyProgram->headLecturer->back_title,
                    'display_name_with_title' => $studyProgram->headLecturer->display_name_with_title,
                    'formal_name' => $studyProgram->headLecturer->formal_name,
