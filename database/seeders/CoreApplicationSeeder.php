    ...
    public function run(): void
    {
        $applications = [
            ...
            [
                'app_code' => 'ta-farmasi',
                'name' => 'TA Farmasi',
                'description' => 'Aplikasi Tugas Akhir Farmasi untuk alur pembimbing, penguji, koordinator, dan pejabat akademik.',
                'base_url' => env('TA_FARMASI_BASE_URL', null),
                'admin_url' => env('TA_FARMASI_ADMIN_URL', null),
                'icon' => 'academic-cap',
                'color' => '#2563eb',
                'is_public_visible' => false,
                'requires_login' => true,
